...
define void @simInit() local_unnamed_addr #0 {
  ...
  %2 = tail call i32 @SDL_CreateWindowAndRenderer(i32 noundef 500, i32 noundef 500, i32 noundef 0, ptr noundef nonnull @Window, ptr noundef nonnull @Renderer) #5
  %3 = load ptr, ptr @Renderer, align 8, !tbaa !4
  ...
  %5 = load ptr, ptr @Renderer, align 8, !tbaa !4
  ...
  %9 = load ptr, ptr @Renderer, align 8, !tbaa !4
...
17:                                               ; preds = %0
  %18 = tail call i32 @SDL_GetTicks() #5
  %19 = load i32, ptr @Ticks, align 4, !tbaa !8
  %20 = icmp eq i32 %18, %19
  br i1 %20, label %21, label %22

21:                                               ; preds = %17
  tail call void @SDL_Delay(i32 noundef 1) #5
  br label %22

22:                                               ; preds = %17, %21
  %23 = load ptr, ptr @Renderer, align 8, !tbaa !4
  tail call void @SDL_RenderPresent(ptr noundef %23) #5
  ret void
}
...
9:                                                ; preds = %6
  ...
  %17 = load ptr, ptr @Renderer, align 8, !tbaa !4
...
8:                                                ; preds = %2
  ...
  %10 = load ptr, ptr @Window, align 8, !tbaa !4
...
4:                                                ; preds = %0
  ...
  %6 = load i32, ptr @Ticks, align 4, !tbaa !8
  %7 = icmp eq i32 %5, %6
...
9:                                                ; preds = %8, %4
  %10 = load ptr, ptr @Renderer, align 8, !tbaa !4
  tail call void @SDL_RenderPresent(ptr noundef %10) #5
  ret void
}
...
attributes #2 = { nounwind "no-trapping-math"="true" "stack-protector-buffer-size"="4" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "zero-call-used-regs"="used-gpr" }
