...
void init(
          F32_FLOAT_T *SPHERE_X, 
          F32_FLOAT_T *SPHERE_Y, 
          F32_FLOAT_T *SPHERE_Z, 
          F32_FLOAT_T *SPHERE_R, 
          F32_FLOAT_T *SPHERE_REFL, 
          COLOR_T *SPHERE_COLOR
        ) {
  SPHERE_X[0] = F32_30 | F32_S_MASK;
  SPHERE_X[1] = F32_30;
  SPHERE_X[2] = F32_0;
  ...
  SPHERE_Z[0] = SPHERE_Z[1] = SPHERE_Z[2] = F32_30;

  SPHERE_R[0] = SPHERE_R[1] = SPHERE_R[2] = F32_20;

  SPHERE_REFL[0] = SPHERE_REFL[1] = SPHERE_REFL[2] = f32_div(F32_3, F32_4);

  SPHERE_COLOR[0] = 0xFF0000;
  SPHERE_COLOR[1] = 0xFFFF00;
  SPHERE_COLOR[2] = 0x00FF00;
}

void app() {
  F32_FLOAT_T SPHERE_X[SPHERE_CNT];
  F32_FLOAT_T SPHERE_Y[SPHERE_CNT];
  F32_FLOAT_T SPHERE_Z[SPHERE_CNT];
  F32_FLOAT_T SPHERE_R[SPHERE_CNT];
  F32_FLOAT_T SPHERE_REFL[SPHERE_CNT];
  COLOR_T SPHERE_COLOR[SPHERE_CNT];

  init(SPHERE_X, SPHERE_Y, SPHERE_Z, SPHERE_R, SPHERE_REFL, SPHERE_COLOR);
